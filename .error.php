<?php
/*.error.php was part of an original file that was created by Chris Coyer. He is the author of css-tricks.com.
...
/*This checks to see what the server status is and then decides whether or not it needs to display an error code.*/
...
?>
<!-->This is the HTML and CSS styles for the .error.php file.</!-->
<!doctype html>
<html>
<head>
