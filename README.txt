Jason's Branch. Most of the files in here are copies of the main branch plus refactoring the php code into functions.
Do not merge this branch with master. Pull requests can be applied but be advised there are different structuring features
****************************************************************************************************************************
***Group M Members***
----------------------
Jordan Smith
...
List of documents this pertains to:
-----------------------------------
.error.php <- heavily heavily edited. This is not even similar to the original one taken. --Jason
.htaccess <- This file is NOT taken from anyone. This is a standard library file from apache's website (OpenGL License) Actually, this SHOULD be in every folder on the site. --Jason
index_dir.php
index_profile.php
index_main.php
sorrtable.js
