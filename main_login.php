...
if(isset($_POST['email']) && isset($_POST['password']))
{
	...
	if($eval != false)
	{
		echo "Welcome ".$eval;
		$_SESSION['user']=$eval;
		header("location:http://localhost/Group%20M/mainhub.html");
	}
}
	...
	function connect($dbemail,$dbpassword)
	{
		try
		{
			$db = new PDO('mysql:host=localhost;dbname=my_db',$dbemail, $dbpassword);
			return $db;
		}
...
<html>
	...
	<h1 class="logo"><i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The Simplest Way To Stay Up To Date.</i></h1>
		...
		<form action="main_login.php" method = "post"><!-- This is the PHP file its calling when the user hits the login button -->
